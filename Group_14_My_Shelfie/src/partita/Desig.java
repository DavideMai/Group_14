	...
	public static JFrame initialize(int primo, int secondo) throws HeadlessException, IOException {
		...
		case 1:
			BufferedImage bufferedImage1 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\8.jpg"));
		...
		case 2:
			BufferedImage bufferedImage2 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\3.jpg"));
		...
		case 3:
			BufferedImage bufferedImage3 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\1.jpg"));
		...
		case 4:
			BufferedImage bufferedImage4 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\5.jpg"));
		...
		case 5:
			BufferedImage bufferedImage5 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\9.jpg"));
		...
		case 6:
			BufferedImage bufferedImage6 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\11.jpg"));
		...
		case 7:
			BufferedImage bufferedImage7 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\7.jpg"));
		...
		case 8:
			BufferedImage bufferedImage8 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\2.jpg"));
		...
		case 9:
			BufferedImage bufferedImage9 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\10.jpg"));
		...
		case 10:
			BufferedImage bufferedImage10 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\6.jpg"));
		...
		case 11:
			BufferedImage bufferedImage11 = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\12.jpg"));
		...
		case 0:
			BufferedImage bufferedImage = ImageIO
					.read(new File("..\\\\Group_14_My_Shelfie\\\\src\\\\Immagini\\\\4.jpg"));
			Image image = bufferedImage.getScaledInstance(400, 187, Image.SCALE_DEFAULT);
